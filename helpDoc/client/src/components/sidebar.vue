<template lang="html">
  <div :class="{'sidebar':true, 'grey-scroll':true, 'showScroll': showScroll}" @contextmenu.prevent="rclick" @click="opDialog=false" @mouseover="mouseover" @mouseout="mouseout">
    ...
    <div class="rightList" v-show="opDialog===true" :style="{'top':menuTop+'px','left':menuLeft+'px'}">
      <p @click="opFile(0)" v-show="opFloder">+文档</p>
      <p @click="opFile(1)" v-show="opFloder">+文档目录</p>
      <p @click="opFile(2)" v-show="nodeIdx>0">位置上移</p>
      <p @click="opFile(3)" v-show="nodeIdx>0">位置下移</p>
    ...
    <el-dialog
      ...
      <el-input v-model="title" placeholder="文档标题"></el-input>
    ...
    <el-dialog
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="saveTree(2)">保 存</el-button>
      </span>
    </el-dialog>
  </div>
</template>
