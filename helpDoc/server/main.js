...
server.all('*', (req, res, next) => {
  if ((req.method === 'POST' && req.params[0] !== '/docsserver/login') || req.route.path === '/docsserver/mdFile/:id') {
...
server.use('/', express.static('./client/dist/docs'))
server.use('/docsserver/mdimg/img', express.static('./server/storage/upload'))

var site = server.listen(9092, function () {
