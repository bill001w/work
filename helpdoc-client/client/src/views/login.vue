    ...
    <div class="login__box">
      ...
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-ruleForm">
        <el-form-item prop="account">
          <el-input v-model.trim="ruleForm.account" placeholder="请输入账号" class="login__box_account"></el-input>
        </el-form-item>
        <el-form-item prop="pwd">
          <el-input v-model.trim="ruleForm.pwd" placeholder="请输入密码" type="password" @keyup.enter.native="login"></el-input>
        </el-form-item>
        <el-button type="primary" class="login__box_login" @click="login">登录</el-button>
      </el-form>
    </div>
  </div>
</template>
          ...
          this.$http
            ...
            .then(response => {
              if (response.body.code === 1) {
                ...
                this.$router.push("/editor/ct_skill");
              } else {
